	...
	return (
		<section id="events" className="py-24">
			<div className="container mx-auto px-4">
				...
				{/* Featured: SpecHack */}
				<div className="rounded-xl border border-primary/30 bg-primary/5 p-8 md:p-12 mb-8 max-w-4xl mx-auto">
					<span className="font-mono-accent text-xs text-primary tracking-widest">
						FEATURED EVENT
					</span>
					<h3 className="font-display text-2xl md:text-3xl font-bold mt-3 mb-2">404 SpecHack</h3>
					...
					<div className="flex flex-wrap gap-4">
						<a
							...
							target="_blank"
							rel="noopener"
							className="bg-primary text-primary-foreground font-semibold px-6 py-3 rounded-lg hover:opacity-90 transition-opacity text-sm"
						>
							{t("spechack.register")}
						</a>
						<a
				...
				<div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
					{[
						{
							name: "Deeptech Summit 2026",
							location: "Lima, Perú",
							date: "SEP 2026",
						},
						{
							name: "International Demo Day",
							location: "Virtual",
							date: "DEC 2026",
						},
					].map((event) => (
						<div key={event.name} className="rounded-xl border border-border bg-card p-6">
							<h4 className="font-display text-lg font-bold mb-3">{event.name}</h4>
